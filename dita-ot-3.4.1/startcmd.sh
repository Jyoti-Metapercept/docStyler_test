...
NEW_CLASSPATH="$DITA_DIR/lib/jackson-annotations-2.10.1.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jackson-core-2.10.1.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jackson-databind-2.10.1.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jackson-dataformat-yaml-2.10.1.jar:$NEW_CLASSPATH"
...
NEW_CLASSPATH="$DITA_DIR/lib/snakeyaml-1.24.jar:$NEW_CLASSPATH"
